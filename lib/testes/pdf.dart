...
//   String data = (await DateTime.now()).toString();
//   String uuid = (Random().nextInt(9999999)).toString();
//   final pdfPath = '$directory/$data $uuid.pdf';
//   final file = File(pdfPath);
//   await file.writeAsBytes(bytes, flush: true);
//   Share.shareFiles([pdfPath], text: 'Visita - $idVisita');
// }
