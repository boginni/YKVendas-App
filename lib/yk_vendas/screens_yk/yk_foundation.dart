...
class YKFoundation extends StatefulWidget {
  const YKFoundation({Key? key, required this.appUser}) : super(key: key);

  static performRestart(BuildContext context,
...
class _AmbienteState extends State<YKFoundation> {
